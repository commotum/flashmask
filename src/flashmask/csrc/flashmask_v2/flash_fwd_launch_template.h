...
template <int Arch, int kHeadDim, int kHeadDimV, int ClusterM, typename Element, typename ElementOut,
          ...
          bool PackGQA, bool Split, bool V_colmajor, bool Is_flashmask, bool short_seqlen = false>
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    using CollectiveMainloop = std::conditional_t<
        ...
        flash::CollectiveMainloopFwdSm80<kNWarps, kStages, Q_in_regs, TileShape_MNK, kHeadDimV, Element, float, cutlass::arch::Sm80, Is_causal, Is_local, Has_softcap, Varlen, PagedKVNonTMA, AppendKV, PackGQA, Split, Is_flashmask>
    >;
    ...
    if constexpr (size(ClusterShape{}) > 1) {
        ...
        cutlass::launch_kernel_on_cluster(launch_params, kernel, kernel_params); //TODO: support cluster
    } else {
                                ...
                                CLUSTER_SWITCH(cutlass::ceil_div(params.seqlen_q * (!PackGQA ? 1 : params.h / params.h_k), kBlockM) % 2 == 0, Use_cluster, [&] {
                                    static constexpr int ClusterM = Enable_cluster && Use_cluster ? 2 : 1;
                                        run_flash_fwd<Arch, kHeadDim, kHeadDimV, ClusterM, T, T_out, Is_causal,   \
                                                ...
                                                HasQv, PackGQA, Split, V_colmajor, Is_flashmask && !Is_FP8, ShortSeqlen>(params, stream);
                                });
                            });
                        });
                    });
