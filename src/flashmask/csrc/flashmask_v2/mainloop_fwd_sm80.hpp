...
template <int kNWarps, int Stages, bool Q_in_regs, class TileShape_MNK_, int kHeadDimV, class Element_, class ElementAccum_, class ArchTag_,
        ...
        bool PackGQA_, bool Split_, bool Is_flashmask_ = false>
struct CollectiveMainloopFwdSm80 {
    ...
    struct Arguments {
        ...
        int const m_block_dim;
        int const n_block_dim;
        int32_t* __restrict__ const block_mask_ptr = nullptr;
        int const* __restrict__ const write_ptr = nullptr;
        int const kv_chunk_size = 8192;
    };
