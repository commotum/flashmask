...
We strongly recommend configuring a build system. Read more about build systems in the [project configuration](https://docs.astral.sh/uv/concepts/projects/config/#build-systems) documentation.
...
The `uv version` command provides conveniences for updating the version of your package before you publish it.[See the project docs for reading your package's version](https://docs.astral.sh/uv/guides/projects/#viewing-your-version).
...
A complete guide to publishing from GitHub Actions to PyPI can be found in the [GitHub Guide](https://docs.astral.sh/uv/guides/integration/github/#publishing-to-pypi)
