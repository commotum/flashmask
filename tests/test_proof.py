...
def _valid_record(**overrides):
    record = {
        ...
        "profiler_passed": True,
        "speedup_passed": True,
        "speed_proof_passed": True,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"correctness_passed": False}, "correctness_passed is not true"),
        ({"profiler_passed": False}, "profiler_passed is not true"),
        ({"speedup_passed": False}, "speedup_passed is not true"),
        ({"speed_proof_passed": False}, "speed_proof_passed is not true"),
        ...
        ({"selected_backend": None}, "selected_backend is missing"),
        ({"selected_backend": "fa2-compatible"}, "selected_backend is not"),
        ({"required_flashmask_cuda_kernel_markers": None}, "marker list is missing"),
        ({"backward_ready": None}, "backward_ready is not boolean"),
        ({"dense_sdpa_ms": 0.0}, "dense_sdpa_ms must be positive"),
        ({"flashmask_ms": None}, "flashmask_ms is not numeric"),
        ({"min_speedup": 1.0}, "min_speedup 1.0000 is below required"),
